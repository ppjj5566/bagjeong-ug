import servo_state
import kinematic.leg_inverse_kinematic as leg_inverse_kinematic
from math import pi,sqrt,atan2,tan,cos,sin

coxia = 14.8
fermur = 43.5
tidia = 77.3
coxferlen = coxia + fermur
body_side_length = 64.2
cos_60 = 0.5
sin_60 = 0.86602
...
body_center_offset_x = 64.2 * cos_60
body_center_offset_y = (111.2 / 2) * sin_60
...
def bodyInverseKinematic(x = 0, y = 0, z = 0, rot_x = 0, rot_y = 0, rot_z = 0):
    for x in range(6):
        inverseKinematic(x, y, z, rot_x, rot_y, rot_z, x)
